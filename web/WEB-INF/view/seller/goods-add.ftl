		...
		<div class="form form-horizontal" >
			...
			<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="number" min=1 value="1" name="quantity" id="" placeholder="" value="" class="input-text" style="width:90%">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么..." dragonfly="true" onKeyUp=""></textarea>						
					</div>
				</div>	
			</form>	
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<div class="col-sm-9 big-photo">
							<div id="preview">
								<img class="stdImage" id="imghead" border="0" src="/buyer/img/photo_icon.png" width="90" height="90" onclick="$('#previewImg').click();">
							</div>         
			...
			<form action="" id="moreImage-form" enctype="multipart/form-data">
				<div class="row cl">
					...
					<div class="col-sm-9 big-photo">
						<#list 2..4 as i>
						<input type="hidden" name="moreImage-id[]" value="-1">
						<div id="preview${i}">
							<img id="imghead${i}" border="0" src="/buyer/img/photo_icon.png" width="90" height="90" onclick="$('#preview${i}Img').click();">
						</div>         
						<input type="file" name="moreImage[]" onchange="previewImage(this, 'preview${i}')" style="display: none;" id="preview${i}Img">
						</#list>
					</div>        			
				</div>	
			</form>		
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<button onclick="goodsAddSubmit()" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i>确认提交</button>
