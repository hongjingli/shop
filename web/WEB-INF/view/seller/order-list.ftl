                        ...
                        <table cellspacing="0" class="shop_table cart">
                            ...
                            <tbody>                                   
                                ...
                                <td class="actions" colspan="5">
                                    ...
                                    <td class="actions" colspan="5">
                                        <h4>买家信息：</h4>
                                        <label for="">帐号名：<span>${order.buyer.username}</span></label><br>
                                        <label for="">手机号：<span>${order.buyer.phone}</span></label><br>
                                        <label for="">qq：<span>${order.buyer.qq!"（无）"}</span></label><br>
                                        <label for="">联系地址：<span>${order.buyer.address}</span></label><br>
                                        </td>
                                    </tr>
                                </tr>
                                <#if order.status == 0>
                                <tr>									
                                    <td class="actions" colspan="3">                                                
                                        <input type="submit" onclick="confirmOrder(${order.id})" value="确认已收款" name="proceed" class="checkout-button button alt wc-forward">
                                    </td>                                    
                                    <td class="actions" colspan="2">                                                
                                        <input type="submit" onclick="rejectOrder(${order.id})" value="拒绝订单" name="proceed" class="checkout-button button alt wc-forward">
                                    </td>                                    
                                </tr>
                                </#if>
                                </tbody>
